...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('verdict', sa.Enum('legit', 'spam', 'malware', 'unknown', name='verdict'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('pending', 'processing', 'completed', 'failed', name='scanstatus'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('pending', 'polling', 'completed', 'failed', name='providerstatus'),
                  server_default='pending', nullable=False),
        sa.Column('verdict', sa.Enum('legit', 'spam', 'malware', 'unknown', name='verdict'),
                  server_default='unknown', nullable=False),
